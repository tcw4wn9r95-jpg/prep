...
import * as verbschool from './screens/verbschool.js';
 ...
 * that got you there.
 */
const FOCUS_ROUTES = new Set(['session', 'listening', 'grammar', 'numbers', 'builder', 'gender-sort', 'objects', 'forms', 'pairs', 'vocab', 'verbs', 'phrases', 'review', 'mistakes', 'school']);
